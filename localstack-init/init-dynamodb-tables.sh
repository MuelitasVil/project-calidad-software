...
# Modificado para preservar datos existentes
...
# ============================================
if table_exists "auth_ms_usuario"; then
  echo "✅ Tabla auth_ms_usuario ya existe (preservando datos)"
else
...
# Tabla 2: auth_ms_jwt
# ============================================
if table_exists "auth_ms_jwt"; then
  echo "✅ Tabla auth_ms_jwt ya existe (preservando datos)"
else
...
# ============================================
if table_exists "auth_ms_type_user"; then
  echo "✅ Tabla auth_ms_type_user ya existe (preservando datos)"
else
